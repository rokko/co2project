    ...
    <ContainerHome>
      <ContainerTop>
        <img src={Logo} width={"500rem"}></img>
          {!account ?
        <ButtonMetamask onClick={()=>connect()}>Connetti Portafoglio</ButtonMetamask>
              :
              <ButtonMetamask style={{ whiteSpace: 'nowrap',
                  overflow: 'hidden',
                  textOverflow: 'ellipsis'}} onClick={()=>connect()}>{account}</ButtonMetamask>}


              </ContainerTop>
      <ContainerTitle>
        <TitleHome>Discover, collect, and <br/>sell your CO2 credits</TitleHome>
      </ContainerTitle>
      <Co2Listing />
        <TheMission />
    </ContainerHome>
