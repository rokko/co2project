        ...
        <ContainerObiettivo>
          <Zoom top>
            <TestoObiettivo>
              ...
              <br /> Partendo dalle normative messe in atto dai governi al fine
              di combattere quella che è una vera e propria guerra per
              preservare il nostro ambiente, specialmente dal devastante effetto
              serra, siamo in grado di realizzare degli impianti
              ...
              pensiamo di realizzare piccoli progetti ma di grosso impatto
              sociale che possano essere di monito a tutti delle enormi risorse
              naturali di cui l’uomo può disporre.
            </TestoObiettivo>
          </Zoom>
        </ContainerObiettivo>
      </ContainerTotaleObiettivo>
